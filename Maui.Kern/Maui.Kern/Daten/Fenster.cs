...
namespace Maui.Kern.Daten
{
	...
	public class Fensterliste : System.Collections.Generic.List<Fenster>
	{
		...
		public Fenster? Suchen(string name) => 
			this.Find(f => string.Compare(f.Name, name, ignoreCase: true) == 0);
	}
	...
	public class Fenster
	{
		...
		/// das Fenster für Windows Forms,WPF
		/// und MAUI benutzt werden kann</remarks>
